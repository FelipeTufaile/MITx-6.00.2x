...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        # random.random() returns a random float between the semi-open range [0.0, 1.0). Therefore, "self.width*random.random()"
        # or "self.height*random.random()" will return a stepsize that it between the semi-open range [0, self.width) for the x
        # direction and between the semi-open range [0, self.height) for the y direction.
    ...
    def isPositionInRoom(self, pos):
        ...
        # defining the room limits
        x_limit = self.width*0.5
        y_limit = self.height*0.5
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        # Romm is a RectangularRoom represents a rectangular region containing clean or dirty tiles.
        # Therefore, "room" has the following methods
        # 1 - width
        # 2 - height
        # 3 - cleanTileAtPosition
        # 4 - getNumCleanedTiles
        # ...

        # Create an instance of class RectangularRoom
        self.room = room

        # Assigning a speed
        self.speed = speed

        # Assigning a random position to position
        self.position = room.getRandomPosition()

        # Assigning an angle
        self.direction = random.randint(0, 360)

        # Mark the tile under the position "position" as cleaned.
