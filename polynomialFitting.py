...
def fitData(fileName):
    ...
    print("coefficient of determination (R2): " + str(round(r2,3)))
...
def fitData1(fileName):
    ...
    r2 = rSquare(yVals, estYVals)
    print("coefficient of determination (R2) fitData1 - Linear Fit: " + str(round(r2,3)))
    ...
    r2 = rSquare(yVals, estYVals)
    print("coefficient of determination (R2) fitData1 - Cubic Fit: " + str(round(r2,3)))
...
def fitData2(fileName):
    ...
    r2 = rSquare(yVals, estYVals)
    print("coefficient of determination (R2) fitData2 - Linear Fit: " + str(round(r2,3)))
    ...
    r2 = rSquare(yVals, estYVals)
    print("coefficient of determination (R2) fitData2 - Cubic Fit: " + str(round(r2,3)))
...
def fitData3(fileName):
    ...
    r2 = rSquare(yVals, estYVals)
    print("coefficient of determination (R2) fitData3 - Linear Fit: " + str(round(r2,3)))
