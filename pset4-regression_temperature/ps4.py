...
def generate_models(x, y, degs):
    ...
    # convert data into arrays using pylab
    x = np.array(x)
    y = np.array(y)
...
def evaluate_models_on_training(x, y, models):
    ...
    model_label = 'Estimated Data (R2 = ' + str(round(r2_optimal,3)) + ' )'
    plt.scatter(x, y, color = 'blue', label = 'Observed Data')
    plt.plot(x, e_optimal, color = 'red', label = model_label)
    plt.title("Average temperature throughout the years")
    plt.xlabel("Years")
